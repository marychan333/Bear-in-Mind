$(document).ready(function() {
    ...
    $('#rusername').keyup(function() {
        ...
        if ( length >= 2 && length <= 20 ) {
            $.post('home/Register.php', {username: $(this).val(),type:'name'}, function(data, textStatus, xhr) {
    ...
    $('#remail').blur(function() {
        if ($(this).val() != '') {
            ...
            if (reg.test($(this).val())) {
                $.post('home/Register.php', {email: $(this).val(),type: 'email'}, function(data, textStatus, xhr) {
                    if (textStatus == 'success') {
                        if (data == 1) {
